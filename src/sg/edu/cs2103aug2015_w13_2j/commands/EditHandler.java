...
/**
* Edits a task in the master task list.
* An index that refers to the task to be edited is expected to be specified.
* A task name and optional flags/options that need to be edited for that 
* task will also be specified.
* 
* A user feedback message will subsequently be displayed to indicate that 
* this task was edited successfully. If no valid task name was specified 
* in the user command, a user error message will be returned. If the Task 
* index specified is out of range, or does not exist, a user error message 
* will be returned.
* 
* @author Zhu Chunqi
*/
